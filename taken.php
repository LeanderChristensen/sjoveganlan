...
for ($x = 1; $x <= 80; $x++) {
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    ${'seat' . $x} = "$('#seat{$x}').attr('style', 'background-color: #2eb82e !important');$('#seat{$x}').attr('title', 'Ledig!');";
    //echo $x;
    //echo " - ";
    //echo ${'seat' . $x};
    //echo "<br>";
...
for ($c = 81; $c <= 96; $c++) {
  ...
  if (mysqli_num_rows($result2) > 0) {
    ...
    ${'seat' . $c} = "$('#seat{$c}').attr('style', 'background-color: #ff9900 !important');$('#seat{$c}').attr('title', 'Ledig!');";
    //echo $x;
    //echo " - ";
    //echo ${'seat' . $x};
    //echo "<br>";
